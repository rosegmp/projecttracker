alter table public.subcontractor_compliance_documents
...
begin
  ...
  if target_type = 'w9' and target_signed_date is null then
    raise exception 'Enter the Form W-9 signed date.' using errcode = '22023';
  end if;
